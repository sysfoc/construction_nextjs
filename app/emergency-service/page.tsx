...
export default function EmergencyServicePage() {
  ...
  return (
    <main className="max-w-7xl mx-auto">
      {/* Hero Section */}
      <section className="grid grid-cols-2 gap-8 px-12 py-12 bg-gray-50">
        <div className="flex flex-col justify-center">
          <h1 className="text-4xl font-bold mb-3 text-gray-800">
            Emergency Services
          </h1>
          <p className="text-base mb-3 leading-relaxed text-gray-600">
      ...
      <section className="px-12 py-10 bg-gray-100">
        ...
        <div className="grid grid-cols-3 gap-4 max-w-5xl mx-auto">
          {services.map((service) => (
            ...
            >
              <div className="flex items-center justify-center rounded overflow-hidden h-40 mb-4">
                <Image
      ...
      <section className="px-12 py-10 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex gap-6 justify-center mb-8">
            ...
            <a
              href={`mailto:${settings.emergencyEmail}`}
              className="flex-1 text-primary-foreground  max-w-xs p-6 bg-primary rounded-lg transition-colors"
            >
              <MailIcon size={32} className="text-primary-foreground mx-auto mb-2" />
              <p className="text-xs mb-1 font-semibold">
                Send us an Email
              </p>
              <p className="text-sm font-medium">
