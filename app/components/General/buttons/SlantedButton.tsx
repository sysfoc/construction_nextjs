  ...
  return (
    <div className="">
      ...
      >
        ...
        {/* Black diagonal side */}
        <span className="absolute right-0 top-0 h-full w-[50px] bg-black clip-button-side flex items-center justify-center">
          <RiArrowRightDoubleLine className="w-5 h-5 text-white" />
        </span>
      </button>
    </div>
  );
